...
type PostServiceClient interface {
	GetPostById(ctx context.Context, in *PostByIdRequest, opts ...grpc.CallOption) (*Post, error)
...
func (c *postServiceClient) GetPostById(ctx context.Context, in *PostByIdRequest, opts ...grpc.CallOption) (*Post, error) {
...
type PostServiceServer interface {
	GetPostById(context.Context, *PostByIdRequest) (*Post, error)
...
func (UnimplementedPostServiceServer) GetPostById(context.Context, *PostByIdRequest) (*Post, error) {
...
func _PostService_GetPostById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).GetPostById(ctx, req.(*PostByIdRequest))
	}
